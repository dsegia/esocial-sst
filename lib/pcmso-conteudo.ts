...
export const TEXTOS_LEGAIS_PCMSO: SecaoLegal[] = [
  ...
  {
    titulo: 'PLANEJAMENTO DO PCMSO COM BASE NO PGR E NO INVENTÁRIO DE RISCOS',
    paragrafos: [
  ...
  {
    titulo: 'EXAMES MÉDICOS OCUPACIONAIS',
    paragrafos: [
  ...
  {
    titulo: 'ENCAMINHAMENTOS E AFASTAMENTOS',
    paragrafos: [
  ...
  {
    titulo: 'ACOMPANHAMENTO DA SAÚDE MENTAL E DOS RISCOS PSICOSSOCIAIS RELACIONADOS AO TRABALHO',
    paragrafos: [
  ...
  {
    titulo: 'SIGILO MÉDICO E GUARDA DE PRONTUÁRIOS',
    paragrafos: [
  ...
  {
    titulo: 'INTEGRAÇÃO COM O ESOCIAL — EVENTO S-2220',
    paragrafos: [
