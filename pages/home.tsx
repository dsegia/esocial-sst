    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{__html: `
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-primary:hover { background: #1450890; }
        ...
        /* LOGOS */
        .logos-bar { padding: 32px 24px; border-bottom: 1px solid #e5e7eb; text-align: center; }
        .logos-bar p { font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #9ca3af; font-weight: 600; margin-bottom: 20px; }
        .logos-list { display: flex; justify-content: center; align-items: center; gap: 32px; flex-wrap: wrap; opacity: 0.5; }
        .logos-list span { font-size: 13px; font-weight: 700; color: #374151; }
        ...
        .step-arrow { display: flex; align-items: center; justify-content: center; padding-top: 24px; }
        ...
        {menuOpen && (
          <div style={{ background:'#fff', borderTop:'1px solid #e5e7eb', padding:'16px 24px', display:'flex', flexDirection:'column', gap:16 }}>
            ...
            <div style={{ display:'flex', gap:10 }}>
              <a href="/" className="btn-outline" style={{ flex:1, textAlign:'center', textDecoration:'none', padding:'9px', fontSize:13, fontWeight:500, color:'#374151', border:'1px solid #d1d5db', borderRadius:8 }}>Entrar</a>
              <a href="/cadastro" className="btn-primary" style={{ flex:1, textAlign:'center', textDecoration:'none', padding:'9px', fontSize:13, fontWeight:600, color:'#fff', background:'#185FA5', borderRadius:8 }}>Testar grátis</a>
            </div>
          </div>
        )}
      </nav>
      ...
      <div className="stats-bar">
        <div className="stats-inner">
          <div className="stat">
            ...
            <div className="stat-label">Eventos SST suportados</div>
          </div>
          <div className="stat">
            <div className="stat-num">3</div>
            <div className="stat-label">Documentos lidos por IA</div>
          </div>
          <div className="stat">
            <div className="stat-num">14</div>
            <div className="stat-label">Dias grátis no trial</div>
          </div>
          <div className="stat">
            <div className="stat-num">100%</div>
            <div className="stat-label">Conforme normas eSocial</div>
          </div>
        </div>
      </div>
          ...
          <div>
            <div className="ai-card">
              ...
              <div className="ai-doc">
                ...
                <div className="ai-doc-row"><span>CNPJ:</span><span className="ai-doc-val">12.345.678/0001-90</span></div>
              ...
              <div className="ai-doc">
                ...
                <div className="ai-doc-row"><span>CPF:</span><span className="ai-doc-val">123.456.789-00</span></div>
        ...
        <div className="section">
          ...
          <div className="steps-grid">
            <div className="step">
              ...
              <p>Trial gratuito de 14 dias. Cadastre sua empresa e funcionários em minutos.</p>
            </div>
            <div className="step">
              <div className="step-num">2</div>
              <h3>Importe ou preencha</h3>
              <p>Envie um PDF ou preencha os dados do evento SST diretamente no sistema.</p>
            </div>
            <div className="step">
              <div className="step-num">3</div>
              <h3>Valide com a IA</h3>
              <p>A inteligência artificial verifica os dados e sugere correções antes do envio.</p>
            </div>
            <div className="step">
              <div className="step-num">4</div>
              <h3>Transmita ao eSocial</h3>
              <p>Clique em transmitir. O sistema assina, envia ao gov.br e salva o recibo automaticamente.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="section" style={{ paddingTop:0 }}>
          ...
          <div className="pricing-grid">
            ...
            <div className="price-card">
              ...
              <div className="price-amount" style={{ fontSize:28 }}>Sob consulta</div>
              <p className="price-desc">Para grandes grupos empresariais e integrações customizadas.</p>
              <ul className="price-features">
                <li><span className="check">✓</span>Tudo do Profissional</li>
                <li><span className="check">✓</span>Integração via API</li>
                <li><span className="check">✓</span>Usuários ilimitados</li>
                <li><span className="check">✓</span>SLA garantido</li>
                <li><span className="check">✓</span>Onboarding dedicado</li>
                <li><span className="check">✓</span>Domínio personalizado</li>
              </ul>
              <a href="mailto:contato@esocialsst.com.br" className="price-btn price-btn-outline">Falar com vendas</a>
            </div>
          </div>
          ...
          <div className="testimonials-grid">
            <div className="testimonial">
              ...
              <div className="testimonial-author">
                ...
                <div>
                  <div className="testimonial-name">Márcia C.</div>
                  <div className="testimonial-role">Médica do Trabalho · São Paulo</div>
                </div>
              </div>
            </div>
            <div className="testimonial">
              ...
              <div className="testimonial-author">
                ...
                <div>
                  <div className="testimonial-name">Ricardo F.</div>
                  <div className="testimonial-role">Engenheiro de Segurança · Curitiba</div>
                </div>
              </div>
            </div>
            <div className="testimonial">
              ...
              <div className="testimonial-author">
                ...
                <div>
                  <div className="testimonial-name">Patricia S.</div>
                  <div className="testimonial-role">Analista de RH · Belo Horizonte</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="footer-top">
            ...
            <div className="footer-links">
              ...
              <ul>
                ...
                <li><a href="mailto:contato@esocialsst.com.br">Contato</a></li>
              </ul>
            </div>
          </div>
          <div className="footer-bottom">
            <p suppressHydrationWarning>© {new Date().getFullYear()} eSocial SST. Todos os direitos reservados.</p>
